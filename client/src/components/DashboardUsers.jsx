      ...
      <div className="w-275 min-w-[160px] text-center flex items-center justify-center gap-6 relative">
        ...
        {isUserRoleUpdate && (
          <motion.div
            ...
            className="absolute z-10 top-6 right-4 p-4 flex flex-col items-start gap-4 bg-white shadow-xl rounded-md"
          >
            <p className="text-textColor text-[12px] text-sm font-semibold">
